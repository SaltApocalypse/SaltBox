...
public partial class CultureService : ObservableObject
{
    ...
    public string CommonOn => _strings.GetValueOrDefault(nameof(CommonOn), "On");
    public string CommonOff => _strings.GetValueOrDefault(nameof(CommonOff), "Off");
    public string CommonConfig => _strings.GetValueOrDefault(nameof(CommonConfig), "Configuration");
    public string CommonCopy => _strings.GetValueOrDefault(nameof(CommonCopy), "Copy");
    public string CommonExport => _strings.GetValueOrDefault(nameof(CommonExport), "Export");
    public string CommonOpenFolder => _strings.GetValueOrDefault(nameof(CommonOpenFolder), "Open Folder");
    public string CommonSave => _strings.GetValueOrDefault(nameof(CommonSave), "Save");
    public string CommonCancel => _strings.GetValueOrDefault(nameof(CommonCancel), "Cancel");
    public string CommonBrowse => _strings.GetValueOrDefault(nameof(CommonBrowse), "Browse\u2026");
    public string CommonNotificationSystemHint => _strings.GetValueOrDefault(nameof(CommonNotificationSystemHint), "If notifications do not appear, enable SaltBox notifications in System Settings.");
